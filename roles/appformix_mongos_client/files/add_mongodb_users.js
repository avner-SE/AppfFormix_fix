...
// To run:
// mongo add_mongo_users.js --eval "USERNAME=\"<username>\"; PASSWORD=\"<pw>\""
...
//        //db = conn.getDB(controllerConfigDb);
//        db.createUser({user: USERNAME, pwd: PASSWORD, roles: [role: 'dbOwner', db: controllerConfigDb]});
//    }
//    if (!eventsDbAuth) {
//        //db = conn.getDB(eventsDb);
//        db.createUser({user: USERNAME, pwd: PASSWORD, roles: [role: 'dbOwner', db: eventsDb]});
//    }
}
